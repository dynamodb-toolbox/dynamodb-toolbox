...
| format       |            `function`            |                  all                  | A function that transforms the input before sending to the parser. This accepts two arguments, the value passed and an object containing the data from other attributes.                                                                        |
