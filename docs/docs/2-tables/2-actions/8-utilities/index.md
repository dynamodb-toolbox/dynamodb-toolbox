...
- [`CDKTableV2`](../13-cdk/index.md): Derives [AWS CDK](https://aws.amazon.com/cdk/) `TableV2` props from the provided `Table`
- [`TableDTO`](../14-dto/index.md): Builds a [Data Transfer Object](https://en.wikipedia.org/wiki/Data_transfer_object) of the provided `Table`
