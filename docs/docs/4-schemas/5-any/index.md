...
DynamoDB-Toolbox exposes [on-the-shelf transformers](../19-transformers/1-usage.md) (including [`jsonStringify`](../19-transformers/5-json-stringify.md)), so feel free to use them!
