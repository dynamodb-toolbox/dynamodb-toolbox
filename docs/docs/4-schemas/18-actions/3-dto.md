...
- On-the-shelf **transformers** like [`prefix`](../19-transformers/2-prefix.md) and [`jsonStringify`](../19-transformers/5-json-stringify.md) are **correctly serialized**, but **custom transformers** are not.
