...
This action is mostly a **wrapper around the schema [`Parser`](../../../4-schemas/18-actions/1-parse.md) action**, so we highly recommend you read its dedicated documentation first.
