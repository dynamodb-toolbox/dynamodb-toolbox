...
The `prefix` and `suffix` options are now examples of transformers (see the [list of available transformers](../../../docs/4-schemas/17-transformers/1-usage.md) for more infos).
