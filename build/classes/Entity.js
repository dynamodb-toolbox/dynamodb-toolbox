...
class Entity {
    ...
    updateParams(item = {}, options = {}, _a = {}) {
        ...
        Object.keys(required).forEach(field => required[field] && !data[field]
            && error(`'${field}${this.schema.attributes[field].alias ? `/${this.schema.attributes[field].alias}` : ''}' is a required field`)); // end required field check
    ...
    putParams(item = {}, options = {}, params = {}) {
        ...
        // Check for required fields
        Object.keys(required).forEach(field => required[field] !== undefined && !data[field]
            && error(`'${field}${this.schema.attributes[field].alias ? `/${this.schema.attributes[field].alias}` : ''}' is a required field`)); // end required field check
