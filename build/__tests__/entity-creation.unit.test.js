...
describe('Entity creation', () => {
    ...
    it('creates entity w/ table', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create basic table
    ...
    it('creates entity composite key delimiter, prefix and suffix', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create basic table
        const TestTable = new Table_1.default({
            name: 'test-table',
            partitionKey: 'pk',
    ...
    it('creates an attribute with a prefix and suffix', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create basic table
        const TestTable = new Table_1.default({
            name: 'test-table',
            partitionKey: 'pk',
    ...
    it('creates an attribute a transformation function', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create basic table
        const TestTable = new Table_1.default({
            name: 'test-table',
            partitionKey: 'pk',
