...
type ExpectedGetOpts<Attributes extends A.Key = A.Key> = Partial<ExpectedReadOpts<Attributes> & { include: string[] }>

type ExpectedQueryOpts<ResponseAttributes extends A.Key = A.Key,
  FilteredAttributes extends A.Key = A.Key> = Partial<ExpectedReadOpts<ResponseAttributes> & {
  index: string
  limit: number
  reverse: boolean
  entity: string
...
type ExpectedWriteOpts<Attributes extends A.Key = A.Key,
  ReturnValues extends string = string> = Partial<{
  capacity: string
  execute: boolean
  parse: boolean
...
describe('Entity', () => {
  ...
  describe('Entity definition', () => {
    ...
    it('should throw if attribute name is same as alias', () => {
      ...
      expect(() => {
        // 🔨 TOIMPROVE: we could raise error here by preventing Aliases from attributes keys but it wreaks havoc with
        // Readonly / Writable
        new Entity({
          name: entityName,
          createdAlias: 'cr',
  ...
  describe('PK only Entity', () => {
    ...
    describe('get method', () => {
      it('nominal case', () => {
        ...
        type TestGetItemOptions = A.Equals<GetItemOptions,
      ...
      it('contains no timestamp', () => {
        ...
        type TestGetResponse = A.Equals<GetResponse,
    ...
    describe('delete method', () => {
      it('nominal case', () => {
        ...
        type TestDeleteItemOptions = A.Equals<DeleteItemOptions,
          Omit<ExpectedWriteOpts<keyof ExpectedItem | 'hidden', 'NONE' | 'ALL_OLD'>,
            'strictSchemaCheck'>>
      ...
      it('no auto-parsing', () => {
        ...
        type TestDeleteRawResponse = A.Equals<DeleteRawResponse,
      ...
      it('contains no timestamp', () => {
        ...
        type TestDeleteResponse = A.Equals<DeleteResponse,
          Omit<ExpectedItem, 'created' | 'modified'> | undefined>
    ...
    describe('put method', () => {
      it('nominal case', () => {
        ...
        type TestPutItemOptions = A.Equals<PutItemOptions,
      ...
      it('contains no timestamp', () => {
        ...
        type TestPutResponse = A.Equals<PutResponse,
          Omit<ExpectedItem, 'created' | 'modified'> | undefined>
    ...
    describe('update method', () => {
      it('nominal case', () => {
        ...
        type TestUpdateItemOptions = A.Equals<UpdateItemOptions,
          ExpectedWriteOpts<keyof ExpectedItem | 'hidden',
      ...
      it('no auto-parsing', () => {
        ...
        type TestUpdateRawResponse = A.Equals<UpdateRawResponse,
      ...
      it('contains no timestamp', () => {
        ...
        type UpdateItem = A.Await<F.Return<typeof updatePromise>>['Attributes']
        type TestUpdateItem = A.Equals<UpdateItem,
          Omit<ExpectedItem, 'created' | 'modified'> | undefined>
        const testUpdateItem: TestUpdateItem = 1;
        testUpdateItem;
      });
    ...
    describe('query method', () => {
      it('nominal case', () => {
        ...
        type QueryNextItems = A.Await<F.Return<Exclude<A.Await<F.Return<typeof queryPromise>>['next'], undefined>>>['Items']
        ...
        type TestQueryItemsOptions = A.Equals<QueryItemsOptions,
      ...
      it('force no parsing', () => {
        ...
        type QueryNextItems = A.Await<F.Return<Exclude<A.Await<F.Return<typeof queryPromise>>['next'], undefined>>>['Items']
        type TestQueryNextItems = A.Equals<QueryNextItems,
      ...
      it('contains no timestamp', () => {
        ...
        type QueryItems = A.Await<F.Return<typeof queryPromise>>['Items']
        type TestQueryItems = A.Equals<QueryItems,
          Omit<ExpectedItem, 'created' | 'modified'>[] | undefined>
        const testQueryItems: TestQueryItems = 1;
        testQueryItems;
      });
    ...
    describe('scan method', () => {
      it('nominal case', () => {
        ...
        type ScanNextItems = A.Await<F.Return<Exclude<A.Await<F.Return<typeof scanPromise>>['next'], undefined>>>['Items']
        type TestScanNextItems = A.Equals<ScanNextItems,
          DocumentClientType.AttributeMap[] | undefined>
  ...
  describe('PK (mapped) + SK (mapped) Entity', () => {
    ...
    describe('get method', () => {
      ...
      it('filtered attributes', () => {
        ...
        type TestGetItemFilt = A.Equals<GetItemFilt,
    ...
    describe('delete method', () => {
      it('nominal case', () => {
        ...
        type DeleteItem1 = A.Await<F.Return<typeof deletePromise1>
          // @ts-expect-error
          >['Attributes']
        ...
        type DeleteItem2 = A.Await<F.Return<typeof deletePromise2>
          // @ts-expect-error
          >['Attributes']
        ...
        type DeleteItem3 = A.Await<F.Return<typeof deletePromise3>
          // @ts-expect-error
          >['Attributes']
    ...
    describe('update method', () => {
      ...
      it('nominal case', () => {
        ...
        type UpdateItem1 = A.Await<ReturnType<typeof updatePromise1>
          // @ts-expect-error
          >['Attributes']
        ...
        type UpdateItem2 = A.Await<ReturnType<typeof updatePromise2>
          // @ts-expect-error
          >['Attributes']
    ...
    describe('get method', () => {
      describe('MethodItemOverlay', () => {
        ...
        it('returned Item should match MethodItemOverlay, even filtered', () => {
          ...
          type FilteredGetItem = A.Await<F.Return<typeof filteredGetPromise>>['Item']
          type TestFilteredGetItem = A.Equals<FilteredGetItem,
  ...
  describe('Overlayed entity', () => {
    ...
    const ent = new Entity<'TestEntity',
      EntityItemOverlay,
    ...
    describe('delete method', () => {
      describe('EntityOverlay only', () => {
        ...
        it('condition attributes should match EntityItemOverlay', () => {
          ...
          type DeleteItemOptions = DeleteOptions<typeof ent>
          type TestDeleteItemOptions = A.Equals<DeleteItemOptions,
            Omit<ExpectedWriteOpts<keyof EntityItemOverlay, 'NONE' | 'ALL_OLD'>,
              'strictSchemaCheck'>>
          const testDeleteItemOptions: TestDeleteItemOptions = 1;
          testDeleteItemOptions;
        });
        ...
        it('Attributes misses from return type if no or none returnValue option is provided', () => {
          ...
          type DeleteItemNone1 = A.Await<F.Return<typeof deletePromiseNone1>
            // @ts-expect-error
            >['Attributes']
          ...
          type DeleteItemNone2 = A.Await<F.Return<typeof deletePromiseNone2>
            // @ts-expect-error
            >['Attributes']
    ...
    describe('put method', () => {
      describe('EntityItemOverlay', () => {
        ...
        it('Attributes misses from return type if no or none returnValue option is provided', () => {
          ...
          type PutItemNone1 = A.Await<F.Return<typeof putPromiseNone1>
            // @ts-expect-error
            >['Attributes']
          ...
          type PutItemNone2 = A.Await<F.Return<typeof putPromiseNone2>
            // @ts-expect-error
            >['Attributes']
    ...
    describe('update method', () => {
      describe('EntityOverlay only', () => {
        ...
        it('condition attributes should match EntityItemOverlay', () => {
          ...
          type UpdateItemOptions = UpdateOptions<typeof ent>
          type TestUpdateItemOptions = A.Equals<UpdateItemOptions,
            ExpectedWriteOpts<keyof EntityItemOverlay,
              'NONE' | 'UPDATED_OLD' | 'UPDATED_NEW' | 'ALL_OLD' | 'ALL_NEW'>>
          const testUpdateItemOptions: TestUpdateItemOptions = 1;
          testUpdateItemOptions;
        });
        ...
        it('Attributes misses from return type if no or none returnValue option is provided', () => {
          ...
          type None1UpdateAttributes = A.Await<F.Return<typeof none1UpdatePromise>
            // @ts-expect-error
            >['Attributes']
          ...
          type None2UpdateAttributes = A.Await<F.Return<typeof none2UpdatePromise>
            // @ts-expect-error
            >['Attributes']
        ...
        it(
          'Attributes match EntityItemOverlay if UPDATED_OLD, UPDATED_NEW, ALL_OLD & ALL_NEW option is provided',
          () => {
            const updatedOldUpdatePromise = () =>
              ent.update({ ...ck0, num0 }, { returnValues: 'UPDATED_OLD' });
            type UpdatedOldUpdateAttributes = A.Await<F.Return<typeof updatedOldUpdatePromise>>['Attributes']
            type AssertUpdatedOldUpdateAttributes = A.Equals<UpdatedOldUpdateAttributes,
            ...
            type UpdatedNewUpdateAttributes = A.Await<F.Return<typeof updatedNewUpdatePromise>>['Attributes']
            type AssertUpdatedNewUpdateAttributes = A.Equals<UpdatedNewUpdateAttributes,
              EntityItemOverlay | undefined>
            ...
            type AssertAllOldUpdateAttributes = A.Equals<AllOldUpdateAttributes,
              EntityItemOverlay | undefined>
            ...
            type AssertAllNewUpdateAttributes = A.Equals<AllNewUpdateAttributes,
              EntityItemOverlay | undefined>
    ...
    describe('query method', () => {
      describe('EntityOverlay only', () => {
        ...
        it('returned Items should match EntityItemOverlay, even filtered', () => {
          ...
          type TestFilteredQueryItem = A.Equals<FilteredQueryItem,
