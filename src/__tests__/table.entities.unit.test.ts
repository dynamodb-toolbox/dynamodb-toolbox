...
describe('entities', () => {
  ...
  test('fails when using a reserved word as an entity name', () => {
    TestEntity = new Entity({
      name: 'query',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when missing a sort key', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when a sort key should not be defined', () => {
    TestTable = new Table({
      name: 'test-table',
      partitionKey: 'pk'
    })
  ...
  test('fails when table key name conflicts with an attribute name', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when mapping an invalid secondary index', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when mapping an invalid key for a secondary index', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when secondary index mapping conflicts with an entity attribute', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when secondary index mapping is missing either the partition or sort key', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test('fails when attribute conflicts with entityField', () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test(`fails when attribute type conflicts with table's type`, () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test(`adds setType to set types`, () => {
    TestEntity = new Entity({
      name: 'TestEntity',
      attributes: {
        email: { type: 'string', partitionKey: true },
  ...
  test(`fails on invalid entity assignement`, () => {
    expect(() => {
      TestTable.addEntity({})
...
describe('removeEntity', () => {
  ...
  test('removes the given entity from the table', () => {
    TestTable.addEntity(TestEntity)
  ...
  test('fails when removing an invalid entity', () => {
    expect(() => {
      TestTable.removeEntity({})
    }).toThrow('Entity must be an instance of Entity')
  })

  test('removes the property mappings from the table in case only the removed entity has them', () => {
    TestTable.addEntity(TestEntity)
  ...
  test('does not remove the property mappings from the table in case other entities have them', () => {
    TestTable.addEntity(TestEntity)
  ...
  test('removes the property mappings from the table for an entity with indexes', () => {
    TestTable = new Table({
      name: 'TestTable',
      partitionKey: 'pk',
      sortKey: 'sk',
  ...
  test('removes the property index mappings from the table for an entity with indexes', () => {
    TestTable = new Table({
      name: 'TestTable',
      partitionKey: 'pk',
      sortKey: 'sk',
  ...
  test('does not remove the property index mappings from the table in case other entities have them', () => {
    TestTable = new Table({
      name: 'TestTable',
      partitionKey: 'pk',
      sortKey: 'sk',
