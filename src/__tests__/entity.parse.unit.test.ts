...
// Create basic entity
import MockEntity from './entities/test-entity'
import MockSimpleEntity from './entities/simple-entity'
const TestEntity = new Entity(MockEntity as any)
const SimpleEntity = new Entity(MockSimpleEntity as any)
