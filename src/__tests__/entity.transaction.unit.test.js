...
describe('Entity transactional operations', () => {
    ...
    describe('putTransaction', () => {
        ...
        it('omits unmapped attributes when strictSchemaCheck is false.', () => {
            const { Put: { Item } } = TestEntity.putTransaction({ pk: 'x', sk: 'y', unknown: '?' }, { strictSchemaCheck: false });
        ...
        it('passes the correct parameters to putParams.', async () => {
            TestEntity.putTransaction({ pk: 'some-pk', sk: 'some-sk', testString: 'some-test-string' }, {
                returnValues: 'ALL_OLD'
            }, {
                ExpressionAttributeValues: {
        ...
        it('transforms ReturnValues into ReturnValuesOnConditionCheckFailure if provided.', async () => {
            ...
            const result = TestEntity.putTransaction({ pk: 'some-pk', sk: 'some-sk', testString: 'some-test-string-with-change' }, {
                returnValues: 'ALL_OLD'
            });
            // @ts-expect-error
            expect(result.ReturnValues).toBeUndefined();
    ...
    describe('updateTransaction', () => {
        ...
        it('omits unmapped attributes when strictSchemaCheck is false.', () => {
            const { Update: { UpdateExpression, ExpressionAttributeNames, ExpressionAttributeValues } } = TestEntity.updateTransaction({ pk: 'x', sk: 'y', testString: 'some-updated-test-string', unknown: '?' }, { strictSchemaCheck: false });
        ...
        it('passes the correct parameters to updateParams.', async () => {
            TestEntity.updateTransaction({ pk: 'some-pk', sk: 'some-sk', testString: 'some-test-string' }, {
                returnValues: 'ALL_OLD'
            }, {
                ExpressionAttributeValues: {
                    ':testString': 'best-test-string'
        ...
        it('transforms ReturnValues into ReturnValuesOnConditionCheckFailure if provided.', async () => {
            ...
            const result = TestEntity.updateTransaction({ pk: 'some-pk', sk: 'some-sk', testString: 'some-test-string-with-change' }, {
                returnValues: 'ALL_OLD'
            });
            // @ts-expect-error
            expect(result.ReturnValues).toBeUndefined();
