...
describe('update', () => {
  ...
  it(
    'doesn\'t provide a default list value when not appending/prepending a value to a nested list within a map.',
    () => {
      let {
        TableName,
        Key,
  ...
  it('should use the non-provided fields\'s default value if isPartialUpdate option is falsy', async () => {
    ...
    expect(ExpressionAttributeValues).toEqual({
      ...
      ':_ct': '2022-08-31T13:27:29.272Z',
      ':_et': 'TestEntity',
      ':_md': '2022-08-31T13:27:29.272Z',
      ':test_boolean_default': false,
      ':test_number_coerce': 0,
    });
  });
