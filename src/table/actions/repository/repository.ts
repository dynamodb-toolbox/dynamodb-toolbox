...
> extends TableAction<TABLE, ENTITIES> {
  ...
  accessPattern<
    ...
    DEFAULT_OPTIONS extends QueryOptions<TABLE, ENTITIES> = QueryOptions<TABLE, ENTITIES>,
    CONTEXT_OPTIONS extends QueryOptions<TABLE, ENTITIES> = QueryOptions<TABLE, ENTITIES>
  >(
    schema: SCHEMA,
