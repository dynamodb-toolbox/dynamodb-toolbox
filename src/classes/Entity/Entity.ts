...
class Entity<EntityItemOverlay extends Overlay = undefined,
  ...
  ReadonlyAttributeDefinitions extends PreventKeys<AttributeDefinitions | Readonly<AttributeDefinitions>,
  ...
  Attributes extends ParsedAttributes = If<A.Equals<EntityItemOverlay, undefined>,
  ...
  $Item extends any = If<A.Equals<EntityItemOverlay, undefined>,
  ...
  CompositePrimaryKey extends O.Object = If<A.Equals<EntityItemOverlay, undefined>,
  ...
  get sortKey(): If<A.Equals<Attributes['key']['sortKey']['pure'], never>,
    null,
  ...
  async get<MethodItemOverlay extends Overlay = undefined,
    ...
    If<B.Not<ShouldParse<Parse, AutoParse>>,
      ...
      A.Compute<O.Update<DocumentClient.GetItemOutput,
        'Item',
  ...
  getTransaction<MethodItemOverlay extends Overlay = undefined,
    ...
    Entity: Entity<EntityItemOverlay,
    ...
    let payload = this.getParams<MethodItemOverlay,
      MethodCompositeKeyOverlay,
      ShownItemAttributes,
    ...
    If<B.Not<ShouldParse<Parse, AutoParse>>,
      ...
      If<// If MethodItemOverlay is defined, ReturnValues is not inferred from args anymore
        ...
        O.Update<DocumentClient.DeleteItemOutput,
          'Attributes',
          FirstDefined<[MethodItemOverlay, EntityItemOverlay, A.Compute<O.Pick<Item, ResponseAttributes>>]>>>>>> {
  ...
  ): Promise<A.Compute<If<B.Not<ShouldExecute<Execute, AutoExecute>>,
