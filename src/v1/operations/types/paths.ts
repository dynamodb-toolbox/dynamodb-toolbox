...
export type AnyAttributePath<SCHEMA extends Schema = Schema> = Schema extends SCHEMA
  ? string
...
> = ENTITIES extends [infer ENTITIES_HEAD, ...infer ENTITIES_TAIL]
  ? ENTITIES_HEAD extends EntityV2
    ? ENTITIES_TAIL extends EntityV2[]
      ? AnyCommonAttributePath<ENTITIES_TAIL, RESULTS & AnyAttributePath<ENTITIES_HEAD['schema']>>
      : never
    : never
  : RESULTS
