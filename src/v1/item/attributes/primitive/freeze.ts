...
>(
  ...
  enumValues?.forEach(enumValue => {
    ...
    if (!isEnumValueValid) {
      throw new DynamoDBToolboxError('item.primitiveAttribute.invalidEnumValueType', {
  ...
  if (
    ...
    if (!typeValidator(defaultValue)) {
      throw new DynamoDBToolboxError('item.primitiveAttribute.invalidDefaultValueType', {
    ...
    if (enumValues !== undefined && !enumValues.some(enumValue => enumValue === defaultValue)) {
      throw new DynamoDBToolboxError('item.primitiveAttribute.invalidDefaultValueRange', {
