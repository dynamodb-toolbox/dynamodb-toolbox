...
export { BatchWriteTableItemsRequest, batchWrite } from './table/actions/batchWrite'
export type { BatchWriteOptions } from './table/actions/batchWrite'
...
export { BatchDeleteItemRequest } from './entity/actions/batchDelete'
export { BatchPutItemRequest } from './entity/actions/batchPut'
