import type { Attribute, ResolvedAttribute, PossiblyUndefinedAdditionalResolution } from 'v1/schema'
    ...
    renameAttributeSavedAsAttributes(
      parseAttributeClonedInput(
        ...
        cloneAttributeInputAndAddDefaults(
          attribute,
          expressionAttributeValue as ResolvedAttribute<PossiblyUndefinedAdditionalResolution>
        )
      )
    )
  )
