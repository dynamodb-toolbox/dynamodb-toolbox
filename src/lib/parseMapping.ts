    ...
    switch (prop) {
      ...
      case "sortKey":
        ...
        if (
          ...
          const indexes = (
            Array.isArray(config[prop]) ? config[prop] : [config[prop]]
          ) as (string | boolean)[];
          ...
          for (let i in indexes) {
            ...
            if (typeof indexes[i] === "boolean") {
              ...
              if (
                ...
                error(
                  `'${field}' attribute cannot be both the partitionKey and sortKey`
                );
              ...
              error(
                `Index assignments for '${field}' must be string or boolean values`
              );
            }
          } // end for
        } else {
