...
describe('zodSchemer > formatter > list', () => {
  ...
  describe('partiality', () => {
    test('returns optional & partial zod schema if partial is true', () => {
      ...
      expect(output).toBeInstanceOf(z.ZodOptional)
      expect(output.unwrap()).toBeInstanceOf(z.ZodArray)
      expect(output.unwrap().element).toBeInstanceOf(z.ZodObject)
      expect(output.unwrap().element.shape.str).toBeInstanceOf(z.ZodOptional)
      expect(output.unwrap().element.shape.str.unwrap()).toBeInstanceOf(z.ZodString)
    ...
    test('returns non-optional & partial zod schema if partial and defined are true', () => {
      ...
      expect(output).toBeInstanceOf(z.ZodArray)
      expect(output.element).toBeInstanceOf(z.ZodObject)
      expect(output.element.shape.str).toBeInstanceOf(z.ZodOptional)
      expect(output.element.shape.str.unwrap()).toBeInstanceOf(z.ZodString)
